...
from Vampire import pbot as app 
from Vampire import arq
from Vampire.services.keyboard import Ikb
from Vampire.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Vampire.services.tasks import _get_tasks_text, all_tasks, rm_task
from Vampire.services.types import InlineQueryResultCachedDocument
from Vampire.modules.info import get_chat_info, get_user_info
from Vampire.modules.music import download_youtube_audio
from Vampire.utils.functions import test_speedtest
from Vampire.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/VampireRobot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Vampire Robot ❤️](https://t.me/decodesupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/team_Vampir)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
