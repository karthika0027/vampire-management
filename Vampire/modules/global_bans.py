...
import Vampire.modules.sql.global_bans_sql as sql
from Vampire.modules.sql.users_sql import get_user_com_chats
from Vampire import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Vampire.modules.helper_funcs.misc import send_to_list
...
*Note:* `Users can appeal spamwatch bans at` @Team_vampir
