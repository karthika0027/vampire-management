...
from Vampire.__main__ import STATS, TOKEN, USER_INFO
from Vampire.modules.sql import SESSION
import Vampire.modules.sql.userinfo_sql as sql
from Vampire.modules.disable import DisableAbleCommandHandler
from Vampire.modules.sql.global_bans_sql import is_user_gbanned
from Vampire.modules.sql.afk_sql import is_afk, set_afk
from Vampire.modules.sql.users_sql import get_user_num_chats
from Vampire.modules.helper_funcs.chat_status import sudo_plus
from Vampire.modules.helper_funcs.extraction import extract_user
from Vampire import telethn
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/VampireLogger/5"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/VampireLogger/6")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Vampire's Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
*What is that health thingy?*
 ...
 `Come and see` [HP System explained](https://t.me/VampireLogger/5)
