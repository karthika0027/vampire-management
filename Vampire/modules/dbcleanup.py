...
import Vampire.modules.sql.global_bans_sql as gban_sql
import Vampire.modules.sql.users_sql as user_sql
from Vampire import DEV_USERS, OWNER_ID, dispatcher
