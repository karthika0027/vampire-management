...
from Vampire import DRAGONS as SUDO_USERS
from Vampire import pbot
from Vampire.modules.sql import forceSubscribe_sql as sql
...
✗ `Vampire can mute members who are not subscribed your channel until they subscribe`
