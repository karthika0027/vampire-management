...
from Vampire.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from Vampire.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Vampire.modules.sql import disable_sql as sql
