...
if ENV:
    ...
    from Vampire.config import Development as Config
...
DRAGONS.add(5432224567)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(5432224567)
...
arq = ARQ(ARQ_API_URL, "UESBQW-LTTGOC-NHYELZ-LPXWOL-ARQ", aiohttpsession)
...
from Vampire.modules.helper_funcs.handlers import (
